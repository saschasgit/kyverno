...
Alle Dateien, die wir hier nutzen, sind auch im Ordner "kyverno-showcase-policies" verfügbar. Wenn in einem Abschnitt eine Datei genutzt wird, steht es direkt unter dem Abschnittsnamen.
